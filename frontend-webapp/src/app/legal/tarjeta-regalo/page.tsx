...
export const metadata = {
  title: 'Tarjeta de Regalo Going App — Going App',
  description: 'Condiciones de compra, canje y vigencia de las tarjetas de regalo Going App (físicas y digitales).',
};
