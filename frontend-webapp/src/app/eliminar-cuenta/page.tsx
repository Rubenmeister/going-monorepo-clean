...
// Espejo del eliminar-cuenta de website/. Play Store requiere una URL
// pública de account deletion accesible — si el listing apunta a
// app.goingec.com/eliminar-cuenta (vs goingec.com) sin esta página
