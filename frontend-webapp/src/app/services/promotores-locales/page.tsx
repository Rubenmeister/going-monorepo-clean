      ...
      <div className="flex flex-1 max-w-screen-xl mx-auto w-full">
        ...
        <main className="flex-1 min-w-0 px-4 lg:px-8 py-6 space-y-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { label: 'Este mes', value: '$—', icon: '💰', color: '#0891b2' },
              { label: 'Tours activos', value: '—', icon: '🗺️', color: '#0033A0' },
              { label: 'Calificación', value: '—', icon: '⭐', color: '#f59e0b' },
              { label: 'Reservas este mes', value: '—', icon: '📅', color: '#16a34a' },
            ].map(kpi => (
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6">
            <h3 className="text-sm font-bold text-gray-500 uppercase tracking-widest mb-4">Mis tours publicados</h3>
