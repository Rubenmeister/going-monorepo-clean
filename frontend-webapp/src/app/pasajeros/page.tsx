      ...
      <section className="pt-12 pb-16 px-4 bg-gray-950">
        <div className="max-w-7xl mx-auto">
          ...
          <FadeIn className="flex justify-center">
            <Link href="/ride" className="px-8 py-4 rounded-2xl font-bold text-white text-base transition-all hover:opacity-90 hover:scale-105" style={{ backgroundColor: '#ff4c41' }}>
              Buscar viaje →
            </Link>
          </FadeIn>
        </div>
      ...
      <section className="py-14 px-6" style={{ background: '#ff4c41' }}>
        <div className="max-w-2xl mx-auto text-center">
          <FadeIn>
            ...
            <Link href="/ride" className="inline-block px-10 py-4 rounded-2xl font-extrabold text-base transition-all duration-200 hover:opacity-90 active:scale-95" style={{ background: '#fff', color: '#ff4c41', boxShadow: '0 4px 24px rgba(0,0,0,0.15)' }}>
              Buscar viaje →
            </Link>
          </FadeIn>
        </div>
