          ...
          <div className="bg-white rounded-xl shadow-md p-8">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-600">Calle Principal 123, Quito, Ecuador</p>
              </div>
              <div>
                <h3 className="font-bold text-gray-900">Teléfono</h3>
                <a href="tel:+593123456789" className="text-blue-600 hover:underline">
                  +593 (1) 234-5678
                </a>
              </div>
              <div>
                <h3 className="font-bold text-gray-900">Email</h3>
                <a href="mailto:hola@going.com" className="text-blue-600 hover:underline">
                  hola@going.com
                </a>
              </div>
              <div>
