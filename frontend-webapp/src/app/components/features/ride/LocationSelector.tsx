...
/**
 * Location selector component with autocomplete suggestions
 */
export function LocationSelector({
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const matches = Object.values(MOCK_LOCATIONS)
      .flat()
      .filter((loc) =>
        loc.address.toLowerCase().includes(newInput.toLowerCase())
      );
