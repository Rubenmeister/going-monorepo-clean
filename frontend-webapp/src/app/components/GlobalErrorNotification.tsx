 ...
 * Displays notifications from UI store at bottom-right corner
 */
  ...
  return (
    ...
    >
          ...
          {notification.action && (
            <button
              ...
              className={`
                ...
                ${textColors[notification.type]} transition-all duration-200
              `}
            >
      ...
      {notification.duration && notification.duration > 0 && (
        <div className={`h-1 bg-opacity-30 ${bgColors[notification.type]}`}>
          <div
