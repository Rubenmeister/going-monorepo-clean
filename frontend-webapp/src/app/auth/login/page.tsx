...
// Login con Facebook OCULTO por defecto (15-jul): la app es tipo Negocios →
// "Facebook Login for Business" exige acceso avanzado a public_profile/email
// (revisión de Meta, no instantáneo). Mostrar el botón daría una opción que
// falla. Google + email sí funcionan. Reactivar con NEXT_PUBLIC_FACEBOOK_LOGIN_ENABLED=true
// cuando Meta apruebe el acceso avanzado.
const FACEBOOK_LOGIN_ENABLED = process.env.NEXT_PUBLIC_FACEBOOK_LOGIN_ENABLED === 'true';
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="space-y-3 mb-6">
            <a
              href={`${API_GW}/auth/google?returnTo=${encodeURIComponent(typeof window !== 'undefined' ? `${window.location.origin}/auth/callback` : '')}`}
            ...
            <a
              href={`${API_GW}/auth/facebook?returnTo=${encodeURIComponent(typeof window !== 'undefined' ? `${window.location.origin}/auth/callback` : '')}`}
