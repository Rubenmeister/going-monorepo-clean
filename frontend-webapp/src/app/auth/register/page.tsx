...
// Registro con Facebook OCULTO por defecto (15-jul): Facebook Login for Business
// exige acceso avanzado (revisión de Meta). Reactivar con
// NEXT_PUBLIC_FACEBOOK_LOGIN_ENABLED=true cuando Meta apruebe. Ver login/page.tsx.
