      ...
      <section className="py-20 px-6" style={{ background: '#f9fafb' }}>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-5">
            <FadeIn delay={0}><ServiceCard icon="🚗" img="/images/serv-compartidos.jpg" title="Viajes Compartidos" desc="La forma más económica de viajar entre ciudades. Comparte el vehículo y el costo." highlight /></FadeIn>
            ...
            <FadeIn delay={160}><ServiceCard icon="📦" img="/images/serv-envios.jpg" title="Envíos Express" desc="Envía paquetes a cualquier ciudad. Tracking en tiempo real incluido." price="Entregas dentro de las 24 horas" /></FadeIn>
          </div>
