...
export class RealtimeBridgeService {
  ...
  private buildBaseSystemPrompt(callId: string, language: string = 'es'): string {
    ...
    return [
      ...
      '- Si una ruta no está en catálogo: ofrece opciones por SMS (send_followup_sms) o',
      '  pregunta por una ciudad cercana. NO derivas.',
      '- Si necesitan info que no pueden anotar: ofrece send_followup_sms.',
