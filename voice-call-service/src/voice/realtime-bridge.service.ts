  ...
  private buildBaseSystemPrompt(callId: string, language: string = 'es'): string {
    if (language === 'en') {
      return [
        ...
        '  warmly ask "anything else I can help with?" and STAY on the call. Say goodbye ONLY',
        '  when the caller says they need nothing more. No rush: warm, calm, unhurried.',
    ...
    return [
      ...
      '  con calidez pregunta "¿te ayudo con algo más?" y QUÉDATE en la llamada. Despídete',
      '  SOLO cuando la persona diga que no necesita nada más o se despida. Sin apuro: tono',
      '  cálido, con calma, como una operadora ecuatoriana amable que tiene tiempo.',
