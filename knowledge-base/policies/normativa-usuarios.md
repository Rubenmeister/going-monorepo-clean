# Normativa para usuarias y usuarios de Going

Reglas de uso de la app para viajeras y viajeros: registro, pagos,
cancelaciones, valoraciones y cuenta.
...
## Cómo se pide un viaje o servicio

- Establecer direcciones (desde / hasta) y elegir el tipo de servicio:
...
- Tras el viaje, la app pide **valorar** el servicio y dejar observaciones
  opcionales; sirve para mejorar la calidad. Going y sus afiliados distribuyen (no
  publican ni verifican) las valoraciones y pueden usarlas, compartirlas y
  mostrarlas.
- Comentarios obscenos u objetables que afecten la privacidad o integridad de una
  persona o de la empresa pueden llevar a la cancelación de esa cuenta.

## Obligaciones y consentimientos

- Usar la plataforma con fines legítimos y éticos, cumpliendo el reglamento.
- Consentir el manejo de **geolocalización** con fines técnicos, de marketing y
  comerciales para proveer y mejorar el servicio.
- Going puede **desactivar o restringir** el acceso ante: incumplimiento del
  reglamento; descrédito que dañe la marca, reputación o negocio; o uso de
  estupefacientes, alcohol o armas que pongan en peligro a ocupantes o terceros.
