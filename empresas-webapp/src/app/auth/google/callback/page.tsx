 ...
 * Ruta: /auth/google/callback?token=...&isNewUser=...
 *
...
import { API_BASE_URL, AUTH_TOKEN_KEY, REFRESH_TOKEN_KEY, USER_INFO_KEY } from "@/lib/constants";
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        setTimeout(() => router.replace("/panel"), 500);
      } catch (e) {
        setStatus("error");
