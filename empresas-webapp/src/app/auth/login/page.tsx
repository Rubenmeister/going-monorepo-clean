 ...
 *   3. "Continuar con Google" → redirige a backend OAuth → callback /auth/google/callback
 */
...
import { signIn, verifyMfaLogin } from "@/lib/auth";
          ...
          <>
            <div className="mt-6 text-center">
              <p className="text-sm text-slate-600">
                ...
                <Link href="/solicitud" className="text-blue-600 hover:text-blue-700 font-semibold">
                  Solicita acceso
                </Link>
              </p>
            </div>
