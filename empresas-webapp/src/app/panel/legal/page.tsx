...
const SECTIONS: DocSection[] = [
  {
    ...
    docs: [
      ...
      },
      {
        ...
        desc: "NDA mutuo entre tu empresa y Thorn AI Technologies para datos de empleados, rutas y reportes.",
        href: "/panel/legal/nda",
        status: "vigente",
      },
      {
