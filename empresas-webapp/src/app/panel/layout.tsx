...
import { useAuthRedirect, signOut } from "@/lib/auth";
import Link from "next/link";
import { usePathname } from "next/navigation";
import { ReactNode, useState, useEffect } from "react";
import { ROLES, TIPOS_CUENTA } from "@/lib/constants";
import { getNavItems, getContexto } from "@/lib/permisos";
      ...
      >
        ...
        <div className="p-5 border-b border-slate-200 shrink-0">
          <Link href="/" className="inline-block">
            <img src="/going-logo-h.png" alt="Going App" className="h-[3.375rem] w-auto" />
          </Link>
