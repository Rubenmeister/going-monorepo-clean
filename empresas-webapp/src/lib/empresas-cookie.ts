 ...
 * exclusivamente los route handlers de /api/auth/*. El middleware
 * la lee para proteger /panel/*.
 *
 * El cliente NO puede leer ni escribir esta cookie. Para login pasa por
 * /api/auth/login, para logout por /api/auth/logout, y
 * para refresh por /api/auth/refresh.
 *
