 ...
 * (con JWT_SECRET, que todos los servicios comparten) y llama al endpoint real
 ...
 *
 * Nota: el DTO de notifications solo acepta { userId, channel, title, body }
 * (ValidationPipe con whitelist descarta extras), así que el payload de
 * deep-link (data) queda como follow-on cuando se extienda el DTO.
 */
