...
const NEWS = [
  { title: 'Going App suma la ruta Quito–Ambato–Baños a su plan de expansión', excerpt: 'Una nueva conexión de Sierra Centro con conductoras y conductores verificados y vehículos 2023 en adelante. Se suma a las rutas con las que arrancamos mientras vamos llegando a todo el país.', date: '8 Abr 2026', img: 'https://images.unsplash.com/photo-1526397751294-331021109fbd?w=700&q=80', cat: 'Rutas', featured: true },
  ...
  { title: 'Going App abre registros: sé de las primeras personas en viajar con nosotros', excerpt: 'Arrancamos con 3 rutas — Riobamba, Santo Domingo e Ibarra, desde Quito y el Aeropuerto de Quito — y vamos llegando a todo el país. Creá tu cuenta y te avisamos cuando tu ruta esté lista.', date: '2 Abr 2026', img: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400&q=80', cat: 'Empresa', featured: false },
  { title: 'Pago con DeUna disponible en Going App a partir de mayo', excerpt: 'Las usuarias y los usuarios podrán pagar sus viajes con el sistema de pagos de billetera móvil del BCE.', date: '28 Mar 2026', img: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80', cat: 'Pagos', featured: false },
