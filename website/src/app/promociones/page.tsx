...
const PROMOS = [
  {
    ...
    desc: 'Válido para nuevas personas usuarias en cualquier ruta de viaje compartido.',
    expires: 'Promo de lanzamiento',
    tag: '🎉 Nuevo usuario',
    color: '#ff4c41',
  },
  {
    code: 'SIERRA10',
    discount: '10% OFF',
    title: 'Ruta Quito–Riobamba',
    desc: 'Quito, Latacunga, Ambato y Riobamba. En toda la ruta compartida.',
    expires: 'Promo de lanzamiento',
    tag: '🏔 Ruta destacada',
    color: '#6366f1',
  },
  {
    ...
    desc: '¿Viajan en grupo? La tercera persona viaja gratis en viaje privado.',
    expires: '30 Jun 2026',
    tag: '👥 Grupos',
    color: '#16a34a',
  },
  ...
  },
  {
    ...
    desc: 'Invita a alguien. Cuando complete su primer viaje, ambos ganan $5.',
