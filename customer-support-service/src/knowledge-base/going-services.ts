...
export const GOING_SERVICES_KB = {
  ...
  faq_es: [
    ...
    { q: '¿Tiene algún costo cancelar mi reserva?', a: 'La cancelación es sin costo hasta 1 hora y media (90 minutos) antes del viaje, una vez que ya se te asignó conductora o conductor; el valor queda como saldo a favor en tu Going Wallet. Si cancelas con menos de 1 hora y media, o si no te presentas, puede aplicarse una tarifa de cancelación por respeto al tiempo de tu conductora o conductor y de los demás pasajeros.' },
    { q: '¿Puedo cambiar la fecha o la hora de un viaje ya reservado?', a: 'Sí. Modifica los datos del trayecto desde "Mis Viajes" en la app. Mientras haya asientos disponibles en el nuevo horario y lo hagas dentro del margen permitido (mínimo 1 hora y media antes de la salida original), el cambio se procesa de inmediato y sin costo adicional.' },
