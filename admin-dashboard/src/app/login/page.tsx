  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl p-10 w-full max-w-md">
        ...
        {/* Social login (OAuth con Google) */}
        <div className="space-y-3 mb-5">
          <a
            href={`${API_GW}/auth/google?returnTo=${encodeURIComponent(typeof window !== 'undefined' ? `${window.location.origin}/auth/callback` : '')}`}
            className="w-full flex items-center justify-center gap-3 py-2.5 px-4 border border-gray-200 rounded-lg font-semibold text-gray-700 bg-white hover:bg-gray-50 transition-all text-sm"
          >
        ...
        <div className="relative mb-5">
          ...
          <div className="relative flex justify-center text-xs"><span className="px-3 bg-white text-gray-400">o con email de admin</span></div>
        </div>
