...
// Importar desde el directorio con node_modules
const docx = require('C:/Users/USER1/AppData/Roaming/Claude/local-agent-mode-sessions/b6773541-ea51-4f61-a5d4-885390bae024/b7508d72-4c6f-4c23-a33b-2a44e4602e34/local_8f327823-34ee-4fa1-98b5-68189111eb74/outputs/node_modules/docx');
const { Document, Packer, Paragraph, TextRun, PageBreak, AlignmentType, BorderStyle, Footer, PageNumber } = docx;
...
const uploadDir = "C:/Users/USER1/AppData/Roaming/Claude/local-agent-mode-sessions/b6773541-ea51-4f61-a5d4-885390bae024/b7508d72-4c6f-4c23-a33b-2a44e4602e34/local_8f327823-34ee-4fa1-98b5-68189111eb74/uploads";
...
Packer.toBuffer(doc).then(buffer => {
  const outPath = "C:/Users/USER1/going-monorepo-clean/Documentos_Legales_Going_2026.docx";
  fs.writeFileSync(outPath, buffer);
  const stats = fs.statSync(outPath);
  console.log("Success!");
  console.log("File: " + outPath);
  console.log("Size: " + (stats.size / 1024).toFixed(2) + " KB");
  console.log("Documents: " + docCount + "/27");
});
