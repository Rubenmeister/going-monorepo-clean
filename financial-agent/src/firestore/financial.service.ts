...
function docToRide(id: string, data: FirebaseFirestore.DocumentData): Ride {
  return {
    ...
    goingCommission: data.goingCommission || round2((data.fareTotal || 0) * GOING_COMMISSION_RATE),
    driverEarnings: data.driverEarnings || round2((data.fareTotal || 0) * DRIVER_RATE),
