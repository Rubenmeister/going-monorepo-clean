...
export const ChatScreen = ({
  ...
  recipientId = 'b737f525-45c5-41e9-9136-1c2517830d99',
    ...
    <View style={[styles.messageBubble, item.isOwn ? styles.ownMessage : styles.otherMessage]}>
      {!item.isOwn && (
        <Text style={styles.senderRole}>
          {item.senderRole === 'driver' ? '🚗 Conductor' : '👤 Usuario'}
        </Text>
      )}
    ...
    >
      ...
      <View style={styles.header}>
        <Text style={styles.headerTitle}>
          {role === 'user' ? '🚗 Chat con Conductor' : '👤 Chat con Pasajero'}
        </Text>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyText}>Envía un mensaje a tu {role === 'user' ? 'conductor' : 'pasajero'}</Text>
          </View>
        }
      />
