    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.contactBox}>
          <Text style={styles.contactTitle}>¿Tienes preguntas legales o sobre datos?</Text>
          <TouchableOpacity onPress={() => openEmail('soporte@goingec.com')}>
            <Text style={styles.contactEmail}>soporte@goingec.com</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => openEmail('privacidad@goingec.com')}>
            <Text style={[styles.contactEmail, { marginTop: 4 }]}>privacidad@goingec.com</Text>
          </TouchableOpacity>
          <Text style={styles.contactAddress}>
            Thorn AI Technologies S.A.S. · RUC 1793176925001{'\n'}
            Echeverría N2-170 y Crespo Toral, Quito, Ecuador
          </Text>
        </View>
      </View>
    </ScrollView>
