      ...
      <View style={styles.content}>
        ...
        <View style={styles.introBox}>
          <Text style={styles.introText}>
            En Going App Ecuador valoramos tu privacidad. Esta política explica qué datos recopilamos,
